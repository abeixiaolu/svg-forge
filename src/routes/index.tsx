...
const SplitPane = (SplitPaneLib.default || SplitPaneLib) as unknown as React.ComponentType<any>;
  ...
  >
    ...
    <g
      className={`transition-all duration-300 ${
        isOpen ? "opacity-100 delay-100" : "opacity-0 -translate-x-2"
      }`}
    >
    ...
    <path
      d={
        isOpen ? "M14 12L12 12M13 11L12 12L13 13" : "M7 12L9 12M8 11L9 12L8 13"
      }
      className={`
...
function App() {
  ...
  const [previewSvgOverride, setPreviewSvgOverride] = useState<string | null>(
    null
  );
  ...
  const currentSVG =
    previewSvgOverride ||
    (activeConversation?.svgs && activeConversation.svgs.length > 0
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="flex items-center gap-2 md:gap-3 select-none">
              ...
              <div className="flex flex-col min-w-0">
                <h1 className="text-sm md:text-lg font-bold tracking-widest text-white leading-none truncate">
                  SVG_FORGE
                </h1>
                <span className="text-[10px] text-primary tracking-[0.2em] font-mono opacity-80 hidden md:block">
                  BUILD v2.0.45
                </span>
              </div>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-4 text-xs font-mono text-tech-dim border-r border-secondary pr-6 h-8">
              <div className="flex items-center gap-2">
                <Activity
                  size={12}
                  className={
                    isLoading ? "text-primary animate-pulse" : "text-tech-dim"
                  }
                />
          ...
          >
            ...
            <div className="flex flex-col h-full w-full border-secondary bg-surface/30 pr-3 min-w-0 min-h-0">
              <div className="h-8 border-b border-secondary bg-surface/50 flex items-center px-4 justify-between shrink-0">
                <span className="text-[10px] font-mono text-tech-dim uppercase tracking-wider">
                  Communication_Link
                </span>
            ...
            <div className="flex flex-col h-full w-full bg-dot-grid relative min-w-0 min-h-0">
              <div className="h-8 border-b border-secondary bg-surface/50 flex items-center px-4 justify-between absolute top-0 left-0 right-0 z-20 backdrop-blur-sm">
                <span className="text-[10px] font-mono text-tech-dim uppercase tracking-wider truncate mr-2">
                  Viewport // {activeConversation?.title || "IDLE"}
                </span>
